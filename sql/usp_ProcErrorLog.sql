...
PURPOSE    : To use within CATCH block of stored procedures for error handling on SQL Server 2012.
ACCEPTS    : ErrorLogID
RETURNS    : ErrorLogID
CALLED BY  : DW stored procs on SQL Server 2012
...
----------------------  ----------------- --------------------------------------------------------------------------------------------
Fausto Gonzalez	    12/23/2014		  Stored procedure created
Fausto Gonzalez	    12/30/2014		  Added documentation
======================================================================================================================================
*/
BEGIN
   SET NOCOUNT ON;
